      ...
      <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className={`rounded-lg p-4 border ${results.captionErrorCount > 0
                  ? 'bg-red-50 border-red-200'
                  : 'bg-green-50 border-green-200'
                  }`}>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Số Lỗi:</span>
                    <span className={`font-bold text-lg ${results.captionErrorCount > 0 ? 'text-red-600' : 'text-green-600'
                      }`}>
              ...
              <div className="space-y-3">
                ...
                <div className={`rounded-lg p-4 border ${results.linkErrorCount > 0
                  ? 'bg-red-50 border-red-200'
                  : 'bg-green-50 border-green-200'
                  }`}>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Số Lỗi:</span>
                    <span className={`font-bold text-lg ${results.linkErrorCount > 0 ? 'text-red-600' : 'text-green-600'
                      }`}>
        ...
        <div className="mt-6">
          <h4 className="font-medium text-gray-700 mb-3 flex items-center">
            ...
            Chi tiết File Caption
          </h4>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse border border-gray-200">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-2 text-left">STT</th>
                  <th className="border border-gray-200 px-4 py-2 text-left">Path</th>
                  <th className="border border-gray-200 px-4 py-2 text-left">Số Items</th>
                ...
                {results.captionResult.map((item: any, index: number) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="border border-gray-200 px-4 py-2 text-center">
                      <span className={`px-2 py-1 rounded text-xs font-semibold ${item.totalItems < 5
              ...
              <tbody>
                {results.linkResult.map((item: any, index: number) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="border border-gray-200 px-4 py-2 text-center">
                      <span className={`px-2 py-1 rounded text-xs font-semibold ${item.totalItems < 1
