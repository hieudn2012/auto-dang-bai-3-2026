          ...
          <div className="flex gap-3 pt-4">
            ...
            {editingIndex !== null && (
              <Button
                ...
                className="px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white font-medium shadow-md transition-all duration-200 dark:bg-gray-600 dark:hover:bg-gray-500"
              >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
            <i className="fas fa-table text-purple-500 dark:text-purple-400 mr-2"></i>
            Danh Sách Captions
          </h3>
          <div className="bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300 px-3 py-1 rounded-full text-sm font-medium">
            {captions.length} captions
          </div>
        </div>
        {captions.length === 0 ? (
          <div className="text-center py-12 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
            <i className="fas fa-inbox text-gray-400 dark:text-gray-500 text-5xl mb-4"></i>
            <h4 className="text-lg font-medium text-gray-600 dark:text-gray-300 mb-2">Chưa có caption nào</h4>
            <p className="text-gray-500 dark:text-gray-400">Thêm caption đầu tiên để bắt đầu quản lý</p>
          </div>
        ) : (
          <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
            <table className="min-w-full bg-white dark:bg-gray-800">
              <thead className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700">
                <tr>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {captions.map((caption, index) => (
                  <tr key={index} className="hover:bg-blue-50 dark:hover:bg-gray-700/30 transition-colors duration-150">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300 rounded-full flex items-center justify-center text-sm font-semibold">
                          {index + 1}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="max-w-md">
                        <p className="text-gray-900 dark:text-gray-100 text-sm line-clamp-2" title={caption.value}>
                          {caption.value}
                        </p>
                      </div>
                    </td>
